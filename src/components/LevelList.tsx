...
const LevelList = ({ reloadKey, setToEdit }: { reloadKey: number, setToEdit: (Catgeory: Database.QuizLevel) => void }) => {
                        ...
                        <TableBody>
                            {levels.length ? levels.map((level, index) => (
                                <TableRow key={level.id}>
                                    ...
                                    <TableCell>
                                        <IconButton aria-label="add an alarm" onClick={() => setToEdit(level)}>
                                            <ModeIcon />
                                        </IconButton>
                                    </TableCell>
                                </TableRow>
